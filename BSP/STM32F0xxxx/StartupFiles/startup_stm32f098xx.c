...
void __attribute__ ((weak)) DMA1_Ch1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak)) DMA1_Ch2_3_DMA2_Ch1_2_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void DMA1_Ch2_3_DMA2_Ch1_2_IRQHandler();
	asm("bkpt 255");
};

void __attribute__ ((weak)) DMA1_Ch4_7_DMA2_Ch3_5_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void DMA1_Ch4_7_DMA2_Ch3_5_IRQHandler();
	asm("bkpt 255");
};
...
void __attribute__ ((weak)) USART3_8_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void DMA1_Ch2_3_DMA2_Ch1_2_IRQHandler()  __attribute__ ((weak, alias ("Default_Handler")));
void DMA1_Ch4_7_DMA2_Ch3_5_IRQHandler()  __attribute__ ((weak, alias ("Default_Handler")));
...
void USART3_8_IRQHandler()               __attribute__ ((weak, alias ("Default_Handler")));
void CEC_CAN_IRQHandler()                __attribute__ ((weak, alias ("Default_Handler")));
#endif

void * g_pfnVectors[0x2f] __attribute__ ((section (".isr_vector"))) = 
{
	&_estack,
	&Reset_Handler,
	&NMI_Handler,
