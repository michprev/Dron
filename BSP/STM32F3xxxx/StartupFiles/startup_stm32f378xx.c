...
void __attribute__ ((weak)) TIM18_DAC2_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void TIM18_DAC2_IRQHandler();
	asm("bkpt 255");
}
...
void __attribute__ ((weak)) TIM12_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak)) TIM13_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak)) SDADC1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void SDADC1_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) SDADC2_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void SDADC2_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) SDADC3_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void SDADC3_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) COMP1_2_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void COMP1_2_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) TIM19_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void TIM18_DAC2_IRQHandler()     __attribute__ ((weak, alias ("Default_Handler")));
