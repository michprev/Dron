...
void __attribute__ ((weak)) AES_LPUART1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void AES_LPUART1_IRQHandler();
	asm("bkpt 255");
}
...
void AES_LPUART1_IRQHandler()          __attribute__ ((weak, alias ("Default_Handler")));
#endif
