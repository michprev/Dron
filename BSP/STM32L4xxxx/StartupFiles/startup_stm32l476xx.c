...
void __attribute__ ((weak)) DFSDM3_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void DFSDM3_IRQHandler();
	asm("bkpt 255");
}
...
void __attribute__ ((weak)) DFSDM0_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void DFSDM0_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) DFSDM1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void DFSDM1_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) DFSDM2_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void DFSDM3_IRQHandler()              __attribute__ ((weak, alias ("Default_Handler")));
...
void DFSDM0_IRQHandler()              __attribute__ ((weak, alias ("Default_Handler")));
void DFSDM1_IRQHandler()              __attribute__ ((weak, alias ("Default_Handler")));
