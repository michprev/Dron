...
static void SystemClock_Config(void)
{
	...
	RCC_OscInitStruct.PLL.PLLM = $$com.sysprogs.examples.stm32.PLLM$$;
	RCC_OscInitStruct.PLL.PLLN = $$com.sysprogs.examples.stm32.PLLN$$;
	RCC_OscInitStruct.PLL.PLLP = $$com.sysprogs.examples.stm32.PLLP$$;
	RCC_OscInitStruct.PLL.PLLQ = $$com.sysprogs.examples.stm32.PLLQ$$;
